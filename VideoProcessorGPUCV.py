...
class VideoProcessor:
    def __init__(self) -> None: 
        self.config = yaml.load(open("./Apps/GPUPipe/config/demo.yaml"), Loader=yaml.FullLoader)
        ...
        with open("./Apps/GPUPipe/model/yolov8n.engine","rb") as f, trt.Runtime(self.logger) as runtime:
